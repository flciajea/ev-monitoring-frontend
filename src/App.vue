    ...
    <template v-if="route.name !== 'login'">
      ...
      <aside class="sidebar" :class="{ open: sidebarOpen }">
        ...
        <nav class="sidebar-nav">
          ...
          <RouterLink to="/keluhan" @click="closeSidebar">Keluhan</RouterLink>
          <RouterLink to="/sparepart" @click="closeSidebar">Sparepart</RouterLink>
          <RouterLink to="/ganti-sparepart" @click="closeSidebar">Ganti Sparepart</RouterLink>
          <RouterLink to="/emisi-karbon" @click="closeSidebar">Emisi Karbon</RouterLink>
        </nav>
